...
public class Livro {
    ...
    private String titulo, edicao, armario, url, prateleira, isbn, descricao, particao;
    private int ano, quantidade,quantE , id, paginas, status, autor_id, editora_id, area_id;
    private String[] info;
