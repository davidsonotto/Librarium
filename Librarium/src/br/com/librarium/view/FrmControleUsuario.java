...
public class FrmControleUsuario extends javax.swing.JFrame implements ListagemModel {
    ...
    private Usuario sup;
    private ArrayList<Usuario> listSupervisor;
    ...
    public FrmControleUsuario(Usuario sup) {
        initComponents();
        setExtendedState(MAXIMIZED_BOTH);
        this.sup = sup;
        ...
        listSupervisor = (ArrayList<Usuario>)dao.buscarTodos("where status_supervisor != 0");
        dao.closeConnection();
        atualizarTabela();
    }
    ...
    public void setList(ArrayList<?> list) {
        this.listSupervisor = (ArrayList<Usuario>)list;
        atualizarTabela();
    }
    ...
    public void verDetalhes() {
        if(isSelected()) {
            ...
            Usuario s = listSupervisor.get(row);
    ...
    private void txt_buscaTextValueChanged(java.awt.event.TextEvent evt) {//GEN-FIRST:event_txt_buscaTextValueChanged
        ...
        if(!busca.equals("")) {
            ...
            UsuarioDao dao = new UsuarioDao();
            listSupervisor = (ArrayList<Usuario>)dao.buscarTodos(clause);
            dao.closeConnection();
        } else {
            UsuarioDao dao = new UsuarioDao();
            listSupervisor = (ArrayList<Usuario>)dao.buscarTodos("where status_supervisor != 0");
