...
public class FrmReserva extends javax.swing.JFrame implements Verificacao {
    ...
    private void initComponents() {
        ...
        label_btn3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        ...
        btn_reservarLayout.setHorizontalGroup(
            ...
            .addComponent(label_btn3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
    ...
    private void btn_reservarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_reservarMouseClicked
        if (validarCampos()) {
            ...
            if (!isAvailable()) {
                int result = JOptionPane.showConfirmDialog(null, "Os exemplares deste livro encontram-se indisponíveis.\nDeseja entrar na lista de espera?");
